...
In addition, I am interested in redesigning the system stack of heterogeneous computing environments that feature diverse computing resources (e.g., CPUs, FPGAs, GPUs, and NPUs) and new interconnects (e.g., CXL).
